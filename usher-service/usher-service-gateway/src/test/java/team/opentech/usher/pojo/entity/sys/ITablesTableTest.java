...
class ITablesTableTest {
    ...
    public void testTableInfo() {
        Field[] fields = MUserInfo.class.getDeclaredFields();
        for (int i = 0; i < fields.length; i++) {
            ...
            System.out.println("fieldInfos.add(new FieldInfo(\"mysql\", \"user\", \"user\", \"" + upperCase + "\", \"" + upperCase + "\", 0, 1, FieldTypeEnum." + typeStr + ", (short) 0, (byte) 0));");
        }
    }
