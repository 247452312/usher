...
import team.opentech.usher.asm.TomcatURLStreamHandlerFactoryDump;
import team.opentech.usher.load.MyUrlClassLoader;
import team.opentech.usher.runner.MyRunnable;
import java.io.File;
import java.net.URL;
...
public class MyRunner {
    ...
    private static void init(String[] args) throws Exception {
        ...
        Executor executor = UsherExecutorWrapper.createByThreadPoolExecutor(new ThreadPoolExecutor(process, process * 2, 3000L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<>(100), new LogDealThreadFactory(), new CallerRunsPolicy()));
