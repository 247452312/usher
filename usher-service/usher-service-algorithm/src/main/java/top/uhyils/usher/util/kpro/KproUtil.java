//package top.uhyils.usher.util.kpro;
//
//import top.uhyils.usher.enum_.DbTypeEnum;
//import top.uhyils.usher.enum_.KeyTypeEnum;
//import top.uhyils.usher.pojo.entity.DbInformation;
//import top.uhyils.usher.pojo.tool.ColumnInfo;
//import top.uhyils.usher.pojo.tool.TableInfo;
...
//        String apiPath = "usher-api/usher-api-provider-" + dbInformation.getSmallProjectName();
//        String servicePath = "usher-service/usher-service-" + dbInformation.getSmallProjectName();
//        for (Map.Entry<String, TableInfo> stringTableInfoEntry : tableInfos.entrySet()) {
//            result.putAll(Objects.requireNonNull(
//                createPojo(apiPath + "/src/main/java/top/uhyils/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat, typeEnum)));
//            result.putAll(Objects.requireNonNull(
//                createDao(servicePath + "/src/main/java/top/uhyils/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat, typeEnum)));
//            result.putAll(Objects.requireNonNull(
//                createMapper(servicePath + "/src/main/resources", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
//            result.putAll(Objects.requireNonNull(
//                createService(apiPath + "/src/main/java/top/uhyils/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
//            result.putAll(Objects.requireNonNull(
//                createServiceImpl(servicePath + "/src/main/java/top/uhyils/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
//            result.putAll(Objects.requireNonNull(
//                createHtml(servicePath + "/src/main/resources/static/page", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
//
//        }
...
//    }
//
//    public static HashMap<String, String> createOther(String apiPath, String servicePath, DbInformation dbInformation, String dateFormat, DbTypeEnum typeEnum) {
...
//    }
//
//    public static Map<? extends String, ? extends String> createHtml(String filepath, String className, TableInfo tableInfo, String dateFormat) {
...
//                return;
//            }
//            detailCols.append("    <div class=\"layui-form-item\">\n        <label class=\"layui-form-label required\">").append(remark)
//                      .append("</label>\n        <div class=\"layui-input-block\">\n            <input type=\"text\" name=\"").append(smallName).append("\" lay-verify=\"required\" placeholder=\"请输入")
//                      .append(remark).append("\" value=\"\"\n                   class=\"layui-input\">\n        </div>\n    </div>\n").toString();
//        });
//
...
//                    .append(className).append("Service\", \"getById\", {\n                id: id\n            }, function (data) {\n                $('[name=\"id\"]').attr('value', data.id);\n")
//                    .append(detailEditCols.toString()).append(
//            "                form.render();\n            })\n        }\n\n        var closeAndReload = function () {\n            var iframeIndex = parent.layer.getFrameIndex(window.name);\n            parent.$.reloadTable();\n            parent.layer.close(iframeIndex);\n        };\n        //监听提交\n        form.on('submit(saveBtn)', function (data) {\n            var index = layer.alert(JSON.stringify(data.field), {\n                title: '最终的提交信息'\n            }, function () {\n                // 关闭弹出层\n                layer.close(index);\n                if (func === 'add') {\n                    pushRequest(\"")
//                    .append(className).append(
//            "Service\", \"insert\", {data: data.field}, function () {\n                    });\n                    closeAndReload();\n                } else if (func === 'edit') {\n                    pushRequest(\"")
//                    .append(className).append(
//            "Service\", \"update\", {data: data.field}, function () {\n                    });\n                    closeAndReload();\n                }\n            });\n            return Boolean.FALSE;\n        });\n\n    });\n</script>\n</body>\n</html>\n");
...
//        sb.append("-XX:+UseG1GC -XX:+PrintGCTimeStamps -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=d:/usher/logs/").append(dbInformation.getSmallProjectName())
//          .append("/JVM_DOWN.dump -Xms512m -Xmx512m -XX:NewRatio=1 -Xloggc:d:/usher/logs/").append(dbInformation.getSmallProjectName()).append("/JVM.log ");
...
//        String fileName = servicePath + "/src/main/java/top/uhyils/usher/" + dbInformation.getBigProjectName() + "Application.java";
//        HashMap<String, String> result = new HashMap<>(1);
//        StringBuilder sb = new StringBuilder();
//        sb.append(
...
//          .append(dbInformation.getBigProjectName()).append("Application {\n    public static void main(String[] args) {\n        SpringApplication.run(").append(dbInformation.getBigProjectName())
...
//        StringBuilder sb = new StringBuilder();
//        sb.append(
//            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!-- 日志级别从低到高分为TRACE < DEBUG < INFO < WARN < ERROR < FATAL，如果设置为WARN，则低于WARN的信息都不会输出 -->\n<!-- scan:当此属性设置为true时，配置文档如果发生改变，将会被重新加载，默认值为true -->\n<!-- scanPeriod:设置监测配置文档是否有修改的时间间隔，如果没有给出时间单位，默认单位是毫秒。\n                 当scan为true时，此属性生效。默认的时间间隔为1分钟。 -->\n<!-- debug:当此属性设置为true时，将打印出logback内部日志信息，实时查看logback运行状态。默认值为false。 -->\n<configuration scan=\"true\" scanPeriod=\"10 seconds\">\n    <contextName>logback</contextName>\n\n    <!-- 获取yml中的log地址 -->\n    <springProperty scope=\"context\" name=\"log.path\" source=\"log-out.path\" defaultValue=\"/usr/usher/logs\"/>\n    <springProperty scope=\"context\" name=\"log.dir.name\" source=\"log-out.dir-name\" defaultValue=\"defaultDir\"/>\n\n    <!--0. 日志格式和颜色渲染 -->\n    <!-- 彩色日志依赖的渲染类 -->\n    <conversionRule conversionWord=\"clr\" converterClass=\"org.springframework.boot.logging.logback.ColorConverter\"/>\n    <conversionRule conversionWord=\"wex\"\n                    converterClass=\"org.springframework.boot.logging.logback.WhitespaceThrowableProxyConverter\"/>\n    <conversionRule conversionWord=\"wEx\"\n                    converterClass=\"org.springframework.boot.logging.logback.ExtendedWhitespaceThrowableProxyConverter\"/>\n    <!-- 彩色日志格式 -->\n    <property name=\"CONSOLE_LOG_PATTERN\"\n              value=\"${CONSOLE_LOG_PATTERN:-%clr(%d{yyyy-MM-dd HH:mm:ss.SSS}){faint}|%clr(${LOG_LEVEL_PATTERN:-%5p})|%clr(${PID:- }){magenta}|%clr([%15.15t]){faint}|%clr(%-40.40logger{39}){cyan} %clr(|){faint} %m%n${LOG_EXCEPTION_CONVERSION_WORD:-%wEx}}\"/>\n\n    <!--1. 输出到控制台-->\n    <appender name=\"CONSOLE\" class=\"ch.qos.logback.core.ConsoleAppender\">\n        <!--此日志appender是为开发使用，只配置最底级别，控制台输出的日志级别是大于或等于此级别的日志信息-->\n        <filter class=\"ch.qos.logback.classic.filter.ThresholdFilter\">\n            <level>debug</level>\n        </filter>\n        <encoder>\n            <Pattern>${CONSOLE_LOG_PATTERN}</Pattern>\n            <!-- 设置字符集 -->\n            <charset>UTF-8</charset>\n        </encoder>\n    </appender>\n\n    <!--2. 输出到文档-->\n    <!-- 2.1 level为 DEBUG 日志，时间滚动输出  -->\n    <appender name=\"DEBUG_FILE\" class=\"top.uhyils.usher.log.filter.MqRollingFileAppender\">\n        <!-- 正在记录的日志文档的路径及文档名 -->\n        <file>${log.path}/${log.dir.name}/debug.log</file>\n        <!--日志文档输出格式-->\n        <encoder>\n            <pattern>%msg%n</pattern>\n            <charset>UTF-8</charset> <!-- 设置字符集 -->\n        </encoder>\n        <!-- 日志记录器的滚动策略，按日期，按大小记录 -->\n        <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n            <!-- 日志归档 -->\n            <fileNamePattern>${log.path}/${log.dir.name}/back_up/%d{yyyy-MM-dd}/debug-%i.log</fileNamePattern>\n            <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n                <maxFileSize>100MB</maxFileSize>\n            </timeBasedFileNamingAndTriggeringPolicy>\n            <!--日志文档保留天数-->\n            <maxHistory>15</maxHistory>\n        </rollingPolicy>\n        <!-- 此日志文档只记录debug级别的 -->\n        <filter class=\"ch.qos.logback.classic.filter.LevelFilter\">\n            <level>debug</level>\n            <onMatch>ACCEPT</onMatch>\n            <onMismatch>DENY</onMismatch>\n        </filter>\n    </appender>\n\n    <!-- 2.2 level为 INFO 日志，时间滚动输出  -->\n    <appender name=\"INFO_FILE\" class=\"top.uhyils.usher.log.filter.MqRollingFileAppender\">\n        <!-- 正在记录的日志文档的路径及文档名 -->\n        <file>${log.path}/${log.dir.name}/info.log</file>\n        <!--日志文档输出格式-->\n        <encoder>\n            <pattern>%msg%n</pattern>\n            <charset>UTF-8</charset>\n        </encoder>\n        <!-- 日志记录器的滚动策略，按日期，按大小记录 -->\n        <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n            <!-- 每天日志归档路径以及格式 -->\n            <fileNamePattern>${log.path}/${log.dir.name}/back_up/%d{yyyy-MM-dd}/info-%i.log</fileNamePattern>\n            <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n                <maxFileSize>100MB</maxFileSize>\n            </timeBasedFileNamingAndTriggeringPolicy>\n            <!--日志文档保留天数-->\n            <maxHistory>15</maxHistory>\n        </rollingPolicy>\n        <!-- 此日志文档只记录info级别的 -->\n        <filter class=\"ch.qos.logback.classic.filter.LevelFilter\">\n            <level>info</level>\n            <onMatch>ACCEPT</onMatch>\n            <onMismatch>DENY</onMismatch>\n        </filter>\n    </appender>\n\n    <!-- 2.3 level为 WARN 日志，时间滚动输出  -->\n    <appender name=\"WARN_FILE\" class=\"top.uhyils.usher.log.filter.MqRollingFileAppender\">\n        <!-- 正在记录的日志文档的路径及文档名 -->\n        <file>${log.path}/${log.dir.name}/warn.log</file>\n        <!--日志文档输出格式-->\n        <encoder>\n            <pattern>%msg%n</pattern>\n            <charset>UTF-8</charset> <!-- 此处设置字符集 -->\n        </encoder>\n        <!-- 日志记录器的滚动策略，按日期，按大小记录 -->\n        <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n            <fileNamePattern>${log.path}/${log.dir.name}/back_up/%d{yyyy-MM-dd}/warn-%i.log</fileNamePattern>\n            <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n                <maxFileSize>100MB</maxFileSize>\n            </timeBasedFileNamingAndTriggeringPolicy>\n            <!--日志文档保留天数-->\n            <maxHistory>15</maxHistory>\n        </rollingPolicy>\n        <!-- 此日志文档只记录warn级别的 -->\n        <filter class=\"ch.qos.logback.classic.filter.LevelFilter\">\n            <level>warn</level>\n            <onMatch>ACCEPT</onMatch>\n            <onMismatch>DENY</onMismatch>\n        </filter>\n    </appender>\n\n    <!-- 2.4 level为 ERROR 日志，时间滚动输出  -->\n    <appender name=\"ERROR_FILE\" class=\"top.uhyils.usher.log.filter.MqRollingFileAppender\">\n        <!-- 正在记录的日志文档的路径及文档名 -->\n        <file>${log.path}/${log.dir.name}/error.log</file>\n        <!--日志文档输出格式-->\n        <encoder>\n            <pattern>%msg%n</pattern>\n            <charset>UTF-8</charset> <!-- 此处设置字符集 -->\n        </encoder>\n        <!-- 日志记录器的滚动策略，按日期，按大小记录 -->\n        <rollingPolicy class=\"ch.qos.logback.core.rolling.TimeBasedRollingPolicy\">\n            <fileNamePattern>${log.path}/${log.dir.name}/back_up/%d{yyyy-MM-dd}/error-%i.log</fileNamePattern>\n            <timeBasedFileNamingAndTriggeringPolicy class=\"ch.qos.logback.core.rolling.SizeAndTimeBasedFNATP\">\n                <maxFileSize>100MB</maxFileSize>\n            </timeBasedFileNamingAndTriggeringPolicy>\n            <!--日志文档保留天数-->\n            <maxHistory>15</maxHistory>\n        </rollingPolicy>\n        <!-- 此日志文档只记录ERROR级别的 -->\n        <filter class=\"ch.qos.logback.classic.filter.LevelFilter\">\n            <level>ERROR</level>\n            <onMatch>ACCEPT</onMatch>\n            <onMismatch>DENY</onMismatch>\n        </filter>\n    </appender>\n\n    <!--\n        <logger>用来设置某一个包或者具体的某一个类的日志打印级别、\n        以及指定<appender>。<logger>仅有一个name属性，\n        一个可选的level和一个可选的addtivity属性。\n        name:用来指定受此logger约束的某一个包或者具体的某一个类。\n        level:用来设置打印级别，大小写无关：TRACE, DEBUG, INFO, WARN, ERROR, ALL 和 OFF，\n              还有一个特俗值INHERITED或者同义词NULL，代表强制执行上级的级别。\n              如果未设置此属性，那么当前logger将会继承上级的级别。\n        addtivity:是否向上级logger传递打印信息。默认是true。\n        <logger name=\"org.springframework.web\" level=\"info\"/>\n        <logger name=\"org.springframework.scheduling.annotation.ScheduledAnnotationBeanPostProcessor\" level=\"INFO\"/>\n    -->\n\n    <!--\n        使用mybatis的时候，sql语句是debug下才会打印，而这里我们只配置了info，所以想要查看sql语句的话，有以下两种操作：\n        第一种把<root level=\"info\">改成<root level=\"DEBUG\">这样就会打印sql，不过这样日志那边会出现很多其他消息\n        第二种就是单独给dao下目录配置debug模式，代码如下，这样配置sql语句会打印，其他还是正常info级别：\n        【logging.level.org.mybatis=debug logging.level.dao=debug】\n     -->\n\n    <!--\n        root节点是必选节点，用来指定最基础的日志输出级别，只有一个level属性\n        level:用来设置打印级别，大小写无关：TRACE, DEBUG, INFO, WARN, ERROR, ALL 和 OFF，\n        不能设置为INHERITED或者同义词NULL。默认是DEBUG\n        可以包含零个或多个元素，标识这个appender将会添加到这个logger。\n    -->\n\n    <!-- 4. 最终的策略 -->\n    <!-- 4.1 开发环境:打印控制台-->\n    <springProfile name=\"dev\">\n        <logger name=\"top.uhyils.usher\" level=\"debug\"/>\n    </springProfile>\n\n    <root level=\"info\">\n        <appender-ref ref=\"CONSOLE\"/>\n        <appender-ref ref=\"DEBUG_FILE\"/>\n        <appender-ref ref=\"INFO_FILE\"/>\n        <appender-ref ref=\"WARN_FILE\"/>\n        <appender-ref ref=\"ERROR_FILE\"/>\n    </root>\n\n    <!-- 4.2 生产环境:输出到文档\n    <springProfile name=\"pro\">\n        <root level=\"info\">\n            <appender-ref ref=\"CONSOLE\" />\n            <appender-ref ref=\"DEBUG_FILE\" />\n            <appender-ref ref=\"INFO_FILE\" />\n            <appender-ref ref=\"ERROR_FILE\" />\n            <appender-ref ref=\"WARN_FILE\" />\n        </root>\n    </springProfile> -->\n\n</configuration>\n");
//        result.put(fileName, sb.toString());
//        return result;
//    }
//
...
//            " -v /usher/logs:/usher/logs --name prod-usher-service-user usher-service/prod-usher-service-user:latest\n\nFROM java:8\n\n#作者\nMAINTAINER uhyils <uhyils@qq.com>\n\n\n#挂载\nVOLUME /usher/logs\n\n#暴露端口\nEXPOSE ")
//          .append(dbInformation.getPort() + 50).append(" ").append(dbInformation.getPort() + 12850).append(
//            "\n\n#应用构建成功后的jar文件被复制到镜像内，名字也改成了app.jar\nADD target/usher-*.jar /app.jar\n\n#启动容器时的进程\nENTRYPOINT [\"java\",\"-Xms512m\",\"-Xmx512m\",\"-XX:+PrintGCTimeStamps\",\"-XX:+UseG1GC\",\"-XX:+HeapDumpOnOutOfMemoryError\",\"-XX:HeapDumpPath=/usher/logs/")
//          .append(dbInformation.getSmallProjectName()).append("/JVM_DOWN.dump\",\"-XX:NewRatio=1\",\"-Xloggc:/usher/logs/").append(dbInformation.getSmallProjectName())
//          .append("/JVM.log\",\"-jar\",\"/app.jar\",\"--spring.profiles.active=prod\"]\n");
...
//            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<project xmlns=\"http://maven.apache.org/POM/4.0.0\"\n         xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n         xsi:schemaLocation=\"http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd\">\n    <parent>\n        <artifactId>usher-service</artifactId>\n        <groupId>top.uhyils.usher</groupId>\n        <version>0.0.7-usher-SNAPSHOT</version>\n    </parent>\n    <modelVersion>4.0.0</modelVersion>\n    <version>0.0.7-usher-SNAPSHOT</version>\n    <artifactId>usher-service-")
//                                              .append(dbInformation.getSmallProjectName()).append(
//                "</artifactId>\n    <packaging>jar</packaging>\n\n    <dependencyManagement>\n        <dependencies>\n            <dependency>\n                <!-- Import dependency management from Spring Boot -->\n                <groupId>org.springframework.boot</groupId>\n                <artifactId>spring-boot-dependencies</artifactId>\n                <version>${spring-boot.version}</version>\n                <type>pom</type>\n                <scope>import</scope>\n            </dependency>\n        </dependencies>\n    </dependencyManagement>\n\n    <dependencies>\n\n        <dependency>\n            <groupId>top.uhyils.usher</groupId>\n            <artifactId>usher-common-base</artifactId>\n        </dependency>\n        <dependency>\n            <groupId>top.uhyils.usher</groupId>\n            <artifactId>usher-common-service</artifactId>\n        </dependency>\n\n        <dependency>\n            <groupId>top.uhyils.usher</groupId>\n            <artifactId>usher-api-provider-")
//                                              .append(dbInformation.getSmallProjectName()).append(
//                "</artifactId>\n        </dependency>\n        <dependency>\n            <groupId>top.uhyils.usher</groupId>\n            <artifactId>usher-api-provider-user</artifactId>\n        </dependency>\n\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-web</artifactId>\n        </dependency>\n\n");
//        switch (typeEnum) {
//            case MYSQL:
...
//        StringBuilder sb = new StringBuilder().append(
//            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<project xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n         xmlns=\"http://maven.apache.org/POM/4.0.0\"\n         xsi:schemaLocation=\"http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd\">\n    <parent>\n        <artifactId>usher-api</artifactId>\n        <groupId>top.uhyils.usher</groupId>\n        <version>0.0.7-usher-SNAPSHOT</version>\n    </parent>\n    <modelVersion>4.0.0</modelVersion>\n    <version>0.0.7-usher-SNAPSHOT</version>\n    <artifactId>usher-api-provider-")
//                                              .append(dbInformation.getSmallProjectName()).append(
//                "</artifactId>\n    <dependencies>\n        <dependency>\n            <groupId>top.uhyils.usher</groupId>\n            <artifactId>usher-common-base</artifactId>\n        </dependency>\n\n        <dependency>\n            <groupId>top.uhyils.usher</groupId>\n            <artifactId>usher-common-service</artifactId>\n        </dependency>\n\n    </dependencies>\n\n</project>\n");
//        HashMap<String, String> result = new HashMap<>(1);
//        result.put(filePath, sb.toString());
...
//    }
//
//    public static HashMap<String, String> createServiceImpl(String filepath, String className, TableInfo tableInfo, String dateFormat) {
//        HashMap<String, String> result = new HashMap<>(1);
//        String fileAllName = filepath + "/serviceImpl/" + className + "ServiceImpl.java";
//        StringBuilder sb = new StringBuilder().append(
//            "package top.uhyils.usher.serviceImpl;\n\nimport top.uhyils.usher.rpc.annotation.RpcService;\nimport top.uhyils.usher.annotation.NoToken;\nimport top.uhyils.usher.content.Content;\nimport top.uhyils.usher.dao.")
//                                              .append(className).append("Dao;\nimport top.uhyils.usher.enum_.ServiceCode;\nimport top.uhyils.usher.pojo.model.*;\nimport top.uhyils.usher.service.").append(className)
...
//    }
//
//    public static HashMap<String, String> createService(String filepath, String className, TableInfo tableInfo, String dateFormat) {
//        HashMap<String, String> result = new HashMap<>(1);
//        String fileAllName = filepath + "/service/" + className + "Service.java";
//        StringBuilder sb = new StringBuilder();
//        sb.append(
//            "package top.uhyils.usher.service;\n\nimport top.uhyils.usher.pojo.model.*;\nimport top.uhyils.usher.service.base.DefaultEntityService;\n\n/**\n *\n * @author uhyils <247452312@qq.com>\n * @date 文件创建日期 ")
//          .append(dateFormat).append("\n */\npublic interface ").append(className).append("Service extends DefaultEntityService<").append(className).append("Entity> {\n\n\n}\n");
//        result.put(fileAllName, sb.toString());
//        return result;
//    }
//
//    public static HashMap<String, String> createDao(String filepath, String className, TableInfo tableInfo, String dateFormat, DbTypeEnum prase) {
//        HashMap<String, String> result = new HashMap<>(1);
//        String fileAllName = filepath + "/dao/" + className + "Dao.java";
//        StringBuilder sb = new StringBuilder();
//        sb.append("package top.uhyils.usher.dao;\n\n");
//        sb.append("import top.uhyils.usher.pojo.model.*;\n");
//        sb.append("import top.uhyils.usher.dao.base.DefaultDao;\n");
...
//    }
//
//    public static HashMap<String, String> createMapper(String filepath, String className, TableInfo tableInfo, String dateFormat) {
//        HashMap<String, String> result = new HashMap<>(1);
//        String fileAllName = filepath + "/mapper/" + className + "DaoMapper.xml";
//        StringBuilder sb = new StringBuilder();
//        sb.append("<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n");
//        sb.append("<!DOCTYPE mapper PUBLIC \"-//mybatis.org//DTD Mapper 3.0//EN\" \"http://mybatis.org/dtd/mybatis-3-mapper.dtd\" >\n\n<mapper namespace=\"top.uhyils.usher.dao.").append(className)
//          .append("Dao\">\n\n\n    <sql id=\"columnList\">\n");
...
//        // 删除最后一个逗号
//        sb.delete(sb.length() - 4, sb.length());
//        sb.append(")\n    </insert>\n\n    <update id=\"update\" parameterType=\"top.uhyils.usher.pojo.model.").append(className);
...
//
//        }
//        sb.append("        where ").append(tableInfo.getOnlyKey().getName()).append(" = #{").append(tableInfo.getOnlyKey().getSmallName())
...
//          .append(tableInfo.getTableName()).append(" a\n        where ${columnName} = #{value}\n    </select>\n\n\n</mapper>\n");
//        result.put(fileAllName, sb.toString());
//        return result;
//    }
//
//    public static Map<String, String> createPojo(String filepath, String className, TableInfo tableInfo, String dateFormat, DbTypeEnum typeEnum) {
...
//        }
//        //package
//        sb.append("package top.uhyils.usher.pojo.model;\n\n");
//
//        //import
//        sb.append("import java.util.*;\n\n");
//        sb.append("import top.uhyils.usher.pojo.model.base.BaseDoEntity;\n\n");
//        sb.append("/**\n" +
//                  " *\n" +
//                  " * @author uhyils <247452312@qq.com>\n" +
//                  " * @date 文件创建日期 " + dateFormat + "\n" +
...
//        sb.append(className);
//        sb.append("Entity extends BaseDoEntity {\n\n");
...
//     * @throws SQLException
//     */
//    private static Map<String, TableInfo> getStringTableInfoHashMap(DbInformation dbInformation, Connection conn) throws SQLException {
...
//        DbInformation dbInformation1 = new DbInformation(dbInformation);
//        dbInformation1.kpro(dateFormat);
//        Map<String, String> mySqlKpro = dbInformation1.result();
//
//        for (Entry<String, String> entry : mySqlKpro.entrySet()) {
