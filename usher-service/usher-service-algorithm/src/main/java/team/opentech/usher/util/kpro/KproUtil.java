...
//
//import team.opentech.usher.enum_.DbTypeEnum;
//import team.opentech.usher.enum_.KeyTypeEnum;
//import team.opentech.usher.pojo.entity.DbInformation;
//import team.opentech.usher.pojo.tool.ColumnInfo;
//import team.opentech.usher.pojo.tool.TableInfo;
...
//                createPojo(apiPath + "/src/main/java/team/opentech/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat, typeEnum)));
//            result.putAll(Objects.requireNonNull(
//                createDao(servicePath + "/src/main/java/team/opentech/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat, typeEnum)));
//            result.putAll(Objects.requireNonNull(
...
//            result.putAll(Objects.requireNonNull(
//                createService(apiPath + "/src/main/java/team/opentech/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
//            result.putAll(Objects.requireNonNull(
//                createServiceImpl(servicePath + "/src/main/java/team/opentech/usher", KproStringUtil.dealDbNameToJavaFileName(stringTableInfoEntry.getKey()), stringTableInfoEntry.getValue(), dateFormat)));
//            result.putAll(Objects.requireNonNull(
...
//        String fileName = servicePath + "/src/main/java/team/opentech/usher/" + dbInformation.getBigProjectName() + "Application.java";
//        HashMap<String, String> result = new HashMap<>(1);
//        StringBuilder sb = new StringBuilder();
//        sb.append(
...
//        StringBuilder sb = new StringBuilder();
//        sb.append(
//            "package team.opentech.usher.service;\n\nimport team.opentech.usher.pojo.model.*;\nimport team.opentech.usher.service.base.DefaultEntityService;\n\n/**\n *\n * @author uhyils <247452312@qq.com>\n * @date 文件创建日期 ")
...
//        StringBuilder sb = new StringBuilder();
//        sb.append("package team.opentech.usher.dao;\n\n");
//        sb.append("import team.opentech.usher.pojo.model.*;\n");
//        sb.append("import team.opentech.usher.dao.base.DefaultDao;\n");
...
//        sb.append("<!DOCTYPE mapper PUBLIC \"-//mybatis.org//DTD Mapper 3.0//EN\" \"http://mybatis.org/dtd/mybatis-3-mapper.dtd\" >\n\n<mapper namespace=\"team.opentech.usher.dao.").append(className)
//          .append("Dao\">\n\n\n    <sql id=\"columnList\">\n");
...
//        // 删除最后一个逗号
//        sb.delete(sb.length() - 4, sb.length());
//        sb.append(")\n    </insert>\n\n    <update id=\"update\" parameterType=\"team.opentech.usher.pojo.model.").append(className);
...
//        }
//        //package
//        sb.append("package team.opentech.usher.pojo.model;\n\n");
//
//        //import
//        sb.append("import java.util.*;\n\n");
//        sb.append("import team.opentech.usher.pojo.model.base.BaseDoEntity;\n\n");
//        sb.append("/**\n" +
//                  " *\n" +
//                  " * @author uhyils <247452312@qq.com>\n" +
//                  " * @date 文件创建日期 " + dateFormat + "\n" +
...
//        dbInformation.setUrl("jdbc:mysql://prod:3306/usher_user");
