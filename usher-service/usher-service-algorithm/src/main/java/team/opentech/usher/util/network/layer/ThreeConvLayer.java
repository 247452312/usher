package team.opentech.usher.util.network.layer;

import team.opentech.usher.util.network.core.ActivationFunction;
import team.opentech.usher.util.network.core.Layer;
import team.opentech.usher.util.network.core.Network;
