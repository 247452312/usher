...
public abstract class AiSubspaceAssembler extends AbstractAssembler<AiSubspaceDO, AiSubspace, AiSubspaceDTO> {
    ...
    @Override
    @Mapping(expression = "java(com.alibaba.fastjson.JSONArray.parseArray(dO.getEdgeCoordinates(),top.uhyils.usher.pojo.DTO.EdgeCoordinaties.class))", target = "edgeCoordinates")
    @Mapping(expression = "java(com.alibaba.fastjson.JSONObject.parseObject(dO.getOriginRelativeCoordinates(),top.uhyils.usher.pojo.DTO.Point3D.class))", target = "originRelativeCoordinates")
