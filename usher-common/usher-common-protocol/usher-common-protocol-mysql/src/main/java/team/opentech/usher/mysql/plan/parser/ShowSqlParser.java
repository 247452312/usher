package team.opentech.usher.mysql.plan.parser;
...
import team.opentech.usher.mysql.pojo.plan.impl.EmptyMysqlPlan;
...
public class ShowSqlParser implements SqlParser {
    ...
    private List<MysqlPlan> doParse(MySqlShowTableStatusStatement sql, Map<String, String> headers) {
        ...
        Asserts.assertTrue(mysqlTcpLink != null, "No database selected");
        String database = mysqlTcpLink.getDatabase();
