 ...
 */
public class ComTableDumpCommand extends AbstractMysqlCommand {

    public ComTableDumpCommand(MysqlThisRequestInfo mysqlThisRequestInfo) {
    ...
    public MysqlCommandTypeEnum type() {
        return MysqlCommandTypeEnum.COM_TABLE_DUMP;
    }
