 ...
 */
public class ComStmtCloseCommand extends AbstractMysqlCommand {

    public ComStmtCloseCommand(MysqlThisRequestInfo mysqlThisRequestInfo) {
    ...
    public MysqlCommandTypeEnum type() {
        return MysqlCommandTypeEnum.COM_STMT_CLOSE;
    }
