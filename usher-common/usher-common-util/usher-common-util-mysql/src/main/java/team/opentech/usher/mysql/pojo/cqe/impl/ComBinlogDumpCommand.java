 ...
 */
public class ComBinlogDumpCommand extends AbstractMysqlCommand {

    public ComBinlogDumpCommand(MysqlThisRequestInfo mysqlThisRequestInfo) {
    ...
    public MysqlCommandTypeEnum type() {
        return MysqlCommandTypeEnum.COM_BINLOG_DUMP;
    }
