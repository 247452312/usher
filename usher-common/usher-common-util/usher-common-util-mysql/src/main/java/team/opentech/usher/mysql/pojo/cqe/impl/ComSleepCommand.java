 ...
 */
public class ComSleepCommand extends AbstractMysqlCommand {

    public ComSleepCommand(MysqlThisRequestInfo mysqlThisRequestInfo) {
    ...
    public MysqlCommandTypeEnum type() {
        return MysqlCommandTypeEnum.COM_SLEEP;
    }
