...
public final class IpUtil {
    ...
    private static final String CLIENT_LOCAL_IP_PROPERTY = "team.opentech.usher.rpc.ip";

    private static final String DEFAULT_SOLVE_FAILED_RETURN = "resolve_failed";

    private static final String CLIENT_LOCAL_PREFER_HOSTNAME_PROPERTY = "team.opentech.usher.rpc.local.preferHostname";
