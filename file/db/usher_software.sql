...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务器表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_server
-- ----------------------------
INSERT INTO `sys_server` VALUES (0, 1591950996, 0, b'0', NULL, 1592352590, 0, '192.168.1.101', '自己电脑上的虚拟机', '1234123', 22, 'root', 2);
...
CREATE TABLE `sys_software`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '中间件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_software
-- ----------------------------
INSERT INTO `sys_software` VALUES (0, 1591968077, 0, b'0', NULL, 1592352634, 0, 'redis-single', NULL, 'uhyils', 6379, 0, 'docker start redis-single', 1, 'docker inspect --format=\'{{.State.Running}}\' redis-single', 'docker stop redis-single', 1, NULL, '5.0.8');
